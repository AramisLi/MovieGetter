 ...
 * nothing in this encoding that indicates where a buffer starts or ends. This
 * means that the encoded text will simply start with the first line of encoded
 * text and end with the last line of encoded text.
 */
